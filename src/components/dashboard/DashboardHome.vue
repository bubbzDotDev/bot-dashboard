      ...
      <div class="guild-card-container">
        ...
        >
          <a
            @click="redirect"
            class="guild-card"
            :href="`https://discord.com/api/oauth2/authorize?client_id=${clientId}&scope=applications.commands%20identify%20guilds%20bot&permissions=${permissions}&guild_id=${availableGuild.id}&disable_guild_select=true`"
            target="_blank"
          >
